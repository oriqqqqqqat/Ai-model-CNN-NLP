...
from concatfeature.ResNet50_BlueBert import MultimodalResNet50


# ===== CONFIG =====
test_csv = "D:/multimodalll/CNN+NLP/data/test.csv"
model_path = "D:/multimodalll/CNN+NLP/weights/best_modelresnet50_bluebert.pth"
batch_size = 8
...
plt.ylabel("True")
plt.tight_layout()
plt.savefig("confusion_matrix_resnetbluebert.png")
plt.show()
print("✅ Saved confusion_matrix_resnetbluebert.png")
...
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=True,
                          save_path="correct_predictionsresnetbluebert_summary.jpg",
                          title="Predictions Correct")

# ❌ แสดง + เซฟภาพทำนายผิด
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=False,
                          save_path="incorrect_predictionsresnetbluebert_summary.jpg",
...
with open("model_performance_resnetbluebert.txt", "w", encoding="utf-8") as f:
...
print("✅ Saved model_performance_resnetbluebert.txt")
