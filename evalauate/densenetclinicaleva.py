...
from concatfeature.DensNet_clinicalbert import MultimodalDenseNet


# ===== CONFIG =====
test_csv = "D:/multimodalll/CNN+NLP/data/test.csv"
model_path = "D:/multimodalll/CNN+NLP/weights/newbest_modeldensenet_clinicalbert.pth"
batch_size = 8
...
# ===== Load Model =====
model = MultimodalDenseNet(num_classes=len(class_names)).to(device)
...
plt.ylabel("True")
plt.tight_layout()
plt.savefig("confusion_matrix_densenetclinicalbert.png")
plt.show()
print("✅ Saved confusion_matrix_densenetclinicalbert.png")
...
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=True,
                          save_path="correct_predictionsdensenetclinicalbert_summary.jpg",
                          title="Predictions Correct")

# ❌ แสดง + เซฟภาพทำนายผิด
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=False,
                          save_path="incorrect_predictionsdensenetclinicalbert_summary.jpg",
...
with open("model_performance_densenetclinicalbert.txt", "w", encoding="utf-8") as f:
...
print("✅ Saved model_performance_densenetclinicalbert.txt")
