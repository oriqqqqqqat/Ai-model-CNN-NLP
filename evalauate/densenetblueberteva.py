...
model_path = "D:/multimodalll/CNN+NLP/weights/newbest_modeldensenet_bluebert.pth"
batch_size = 8
...
plt.ylabel("True")
plt.tight_layout()
plt.savefig("confusion_matrix_densenetbluebert.png")
plt.show()
print("✅ Saved confusion_matrix_densenetbluebert.png")
...
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=True,
                          save_path="correct_predictionsdensenetbluebert_summary.jpg",
                          title="Predictions Correct")

# ❌ แสดง + เซฟภาพทำนายผิด
show_and_save_predictions(file_paths, y_true, y_pred, reverse_label_map,
                          correct=False,
                          save_path="incorrect_predictionsdensenetbluebert_summary.jpg",
...
with open("model_performance_densenetbluebert.txt", "w", encoding="utf-8") as f:
...
print("✅ Saved model_performance_densenetbluebert.txt")
