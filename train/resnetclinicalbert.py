...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "best_modelresnet50_clinicalbert.pth")
        print(f"💾 Saved BEST model (Val Acc: {val_acc:.4f})")
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1

    torch.save(model.state_dict(), "last_modelresnet50_clinicalbert.pth")
...
plt.tight_layout()
plt.savefig("resnetclinicaltraining_plot.png")
plt.show()
