...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "newbest_modelefficientnet_clinicalbert.pth")
        print(f"💾 Saved BEST model (Val Acc: {val_acc:.4f})")
        epochs_no_improve = 0
    else:
        epochs_no_improve += 1

    torch.save(model.state_dict(), "newlast_modelefficientnet_clinicalbert.pth")
...
plt.tight_layout()
plt.savefig("efficientnetclinicaltraining_plot.png")
plt.show()
