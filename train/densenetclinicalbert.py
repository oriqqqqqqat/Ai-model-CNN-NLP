...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "newbest_modeldensenet_clinicalbert.pth")
    ...
    torch.save(model.state_dict(), "newlast_modeldensenet_clinicalbert.pth")
...
plt.tight_layout()
plt.savefig("densenetclinicaltraining_plot.png")
plt.show()
