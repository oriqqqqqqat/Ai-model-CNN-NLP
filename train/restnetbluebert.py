...
for epoch in range(num_epochs):
    ...
    if val_acc > best_val_acc:
        ...
        torch.save(model.state_dict(), "newbest_modelresnet_bluebert.pth")
    ...
    torch.save(model.state_dict(), "newlast_modeldresnet_bluebert.pth")
...
plt.tight_layout()
plt.savefig("resnetblueberttraining_plot.png")
plt.show()
