...
<h3>Step6: Apply </h3>
<p> File app -> load label_map.json and run app.py file to use model on localhost web (weight on this file should be the most efficient model that you have evaluated already)</p>
